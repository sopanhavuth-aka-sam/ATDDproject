...
/* config startdate picker
* direction: false, means past only dates ending today
...
/* same code inside function body
...
/* config enddate picker
* direction: only allow dates in future from selected startdate
* offset shifts datepickers position relative to top right of the icon
*/
$(document).ready(function() {
